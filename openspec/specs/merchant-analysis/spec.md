# Capability: Merchant Analysis

## Purpose

This capability provides insights into spending by merchant, detects recurring subscriptions, and enables users to manage subscriptions through a dedicated dashboard.
