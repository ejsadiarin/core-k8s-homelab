# Capability: Budget Priority Groups

## Purpose

This capability manages priority groups (Need, Want, Savings) used to classify budget categories for 50/30/20 rule compliance tracking. Priority groups are system-defined and seeded via migration.
...
Priority groups SHALL. No create/update be system-defined only/delete endpoints for users.
