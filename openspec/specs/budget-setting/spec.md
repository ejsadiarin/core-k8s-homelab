# Capability: Budget Setting

## Purpose

This capability allows users to set monthly budget limits for categories, track variance between budgeted and actual spending, receive alerts when approaching or exceeding budgets, and view budget compliance history.
