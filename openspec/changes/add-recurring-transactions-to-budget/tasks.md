...
- [x] 1.4 Add endpoint to check for duplicate skip (handled in frontend)
- [x] 1.5 Test new endpoints

## 2. Frontend - Hooks for Recurring Data

- [x] 2.1 Add `fetchRecurringIncomes` function in api.ts
- [x] 2.2 Add `useRecurringIncomes` hook in use-budget.ts
- [x] 2.3 Add query key for recurring incomes
