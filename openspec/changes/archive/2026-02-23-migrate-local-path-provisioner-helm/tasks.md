...
- [x] 4.1 Verify ArgoCD syncs the new Helm chart successfully
- [x] 4.2 Verify StorageClass `local-path` exists with `reclaimPolicy: Retain`
- [x] 4.3 Verify provisioner pod is running with security context
- [x] 4.4 Verify existing PVCs remain bound
