...
Implement a _production-ready, GitOps-managed_ Kubernetes monitoring stack for K3s (and optionally Talos), using VictoriaMetrics, VictoriaLogs, Grafana, Alertmanager, and Vector/Fluent Bit, with dynamic storage (NFS/Longhorn), secure access, and batteries-included dashboards/alerts/log pipelines.
...
- [x] Project initialization command verified (Helm, kubectl, ArgoCD)
