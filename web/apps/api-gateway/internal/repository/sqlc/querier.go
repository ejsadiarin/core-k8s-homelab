...
type Querier interface {
	...
	GetAllRecurringIncomeRules(ctx context.Context, arg GetAllRecurringIncomeRulesParams) ([]RecurringIncomeRule, error)
	...
	GetRecurringIncomeForPeriod(ctx context.Context, arg GetRecurringIncomeForPeriodParams) ([]RecurringIncomeRule, error)
	GetRecurringIncomeRules(ctx context.Context, arg GetRecurringIncomeRulesParams) ([]RecurringIncomeRule, error)
